...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Important Note2}, opacitybacktitle=0.6, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, colback=white, arc=.35mm, toprule=.15mm, breakable, coltitle=black, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm]
