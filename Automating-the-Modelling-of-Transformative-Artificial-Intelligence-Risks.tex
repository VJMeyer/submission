...
\addcontentsline{toc}{section}{For Callouts}

\markright{For Callouts}

Quarto's native callouts work without additional packages:

Remember to connect this back to the research question

\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, breakable, leftrule=.75mm, titlerule=0mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Optional Title}, bottomrule=.15mm, toprule=.15mm, toptitle=1mm, bottomtitle=1mm, colback=white, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, arc=.35mm]

Content here

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, breakable, leftrule=.75mm, titlerule=0mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Important Note2}, bottomrule=.15mm, toprule=.15mm, toptitle=1mm, bottomtitle=1mm, colback=white, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, arc=.35mm]
...
page 2\footnote{Here's one with multiple blocks.
