...
\item
  ...
  power-seeking \texttt{(P≈0.65)}
\end{enumerate}

\textbf{Composite Risk Calculation}: \texttt{P(doom)≈0.05\ (5\%)}
...
\textbf{Premise 1: APS Systems by 2070} \texttt{(P≈0.65)} ``By 2070,
there will be AI systems with Advanced capability, Agentic planning, and
Strategic awareness''---the conjunction of capabilities that could
enable systematic pursuit of objectives in the world.

\textbf{Premise 2: Alignment Difficulty} \texttt{(P≈0.40)} ``It will be
...
\texttt{P(doom)≈0.05} or 5\% by 2070.
...
% \part*{Affidavit}
    ...
    \Large{Declaration of Academic Honesty}
	    \vspace{1cm}\noindent \\
