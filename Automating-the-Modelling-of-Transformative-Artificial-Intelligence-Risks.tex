...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, left=2mm, titlerule=0mm, opacityback=0, arc=.35mm, bottomrule=.15mm, toptitle=1mm, coltitle=black, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Important Note2}, colframe=quarto-callout-note-color-frame, colback=white, rightrule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, opacitybacktitle=0.6]
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\{\{\textless{} embed penguins.ipynb\#fig{-}bill{-}scatter \textgreater{}\}\}}
\NormalTok{or}
\NormalTok{\{\{\textless{} embed /AMTAIR\_Prototype/data/example\_carlsmith/AMTAIR\_Prototype\_example\_carlsmith.ipynb\#@title 0.1 {-}{-}{-} Install \& Import Libraries \& Packages (One{-}Time Setup) {-}{-}{-} \textgreater{}\}\}}

\NormalTok{Caveat: Html comments do not work on Notebook inclusion}
\end{Highlighting}
\end{Shaded}
