...
\begin{verbatim}
<IPython.lib.display.IFrame at 0x1360198d0>
\end{verbatim}
...
\section*{Workflow Rules (apply every
session)}\label{workflow-rules-apply-every-session}
\addcontentsline{toc}{section}{Workflow Rules (apply every session)}

\markright{Workflow Rules (apply every session)}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  \textbf{Before writing}

  \begin{itemize}
  \tightlist
  \item
    Import this prompt; restate the specific task in one sentence.\\
  \item
    Load latest YAML (\texttt{project}, \texttt{format}, bibliography).
  \end{itemize}
\item
...
\item
  ...
  \tightlist
  \item
    Run \texttt{quarto\ render\ -\/-to\ html} locally; resolve
    warnings.\\
  \item
    Tick off § Rigorous Checklist; commit with message ``feat(section):
    x -- refs/glossary/figs updated''.
  \end{itemize}
\end{enumerate}
...
\subsection{Format-Specific Checks}\label{format-specific-checks}
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, titlerule=0mm, opacityback=0, toptitle=1mm, colback=white, breakable, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, toprule=.15mm, coltitle=black, left=2mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{10\% of Grade: \textasciitilde{} 14\% of text \textasciitilde{} 4200
words \textasciitilde{} 10 pages}, bottomrule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, titlerule=0mm, opacityback=0, toptitle=1mm, colback=white, breakable, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, toprule=.15mm, coltitle=black, left=2mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{20\% of Grade: \textasciitilde{} 29\% of text \textasciitilde{} 8700
words \textasciitilde{} 20 pages}, bottomrule=.15mm, leftrule=.75mm]
...
\chapter{Appendices}\label{appendices-2}
