...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Important Note2}, coltitle=black, opacityback=0, bottomtitle=1mm, colback=white, leftrule=.75mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, toptitle=1mm, breakable, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, rightrule=.15mm, opacitybacktitle=0.6]
