...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, breakable, bottomrule=.15mm, arc=.35mm, toprule=.15mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, opacityback=0, titlerule=0mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomtitle=1mm, left=2mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Important Note2}, rightrule=.15mm]
...
\includegraphics[width=6.88in,height=1.81in]{chapters/0.Frontmatter_files/figure-latex/mermaid-figure-1.png}
