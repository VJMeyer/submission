...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colback=white, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, arc=.35mm, titlerule=0mm, opacityback=0, breakable, opacitybacktitle=0.6, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Important Note2}, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, toprule=.15mm, coltitle=black]
