...
\subsection*{Building the Thesis}\label{building-the-thesis}
\addcontentsline{toc}{subsection}{Building the Thesis}

bash

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# HTML output}
\ExtensionTok{quarto}\NormalTok{ render }\AttributeTok{{-}{-}to}\NormalTok{ html}

\CommentTok{\# PDF output}
\ExtensionTok{quarto}\NormalTok{ render }\AttributeTok{{-}{-}to}\NormalTok{ pdf}

\CommentTok{\# All formats}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\textless{}!{-}{-} [ ] }\AlertTok{TODO}\CommentTok{: Task description {-}{-}\textgreater{}}
\CommentTok{\textless{}!{-}{-} [ ] FIND: @missing{-}citation: "Description" {-}{-}\textgreater{}}
\CommentTok{\textless{}!{-}{-} [ ] VERIFY: @suggested{-}citation: "Source" {-}{-}\textgreater{}}
\CommentTok{\textless{}!{-}{-} [ ] CREATE: \{\#fig{-}name\}: "Figure description" {-}{-}\textgreater{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\textless{}!{-}{-} [ ] FIND: @missing{-}citation{-}key: "Description of needed source, keywords, search terms" {-}{-}\textgreater{}}
\CommentTok{\textless{}!{-}{-} [ ] VERIFY: @suggested{-}citation: "Author (Year). Title. Journal." [Include BibTeX if available] {-}{-}\textgreater{}}
\CommentTok{\textless{}!{-}{-} [ ] UPDATE: @outdated{-}citation: "Check for newer edition or updated data" {-}{-}\textgreater{}}
\end{Highlighting}
\end{Shaded}
...
\section*{Reporting and Analytics}\label{reporting-and-analytics}
\addcontentsline{toc}{section}{Reporting and Analytics}

\markright{Reporting and Analytics}

\subsection*{Task Summary Template}\label{task-summary-template}
\addcontentsline{toc}{subsection}{Task Summary Template}

In markdown blocks or with \texttt{verbatim\ code} ticks:

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\textless{}!{-}{-} }\AlertTok{TASK}\CommentTok{ SUMMARY: Chapter 3}
\CommentTok{  Total tasks: 45}
\CommentTok{  Completed: 32 (71\%)}
\CommentTok{  In progress: 8 (18\%)}
\CommentTok{  Open: 5 (11\%)}
\CommentTok{  }
\CommentTok{  By category:}
\CommentTok{  {-} WRITE: 15 tasks (10 complete)}
\CommentTok{  {-} FIND: 12 tasks (8 complete)}
\CommentTok{  {-} VERIFY: 8 tasks (7 complete)}
\CommentTok{  {-} CREATE: 10 tasks (7 complete)}
\CommentTok{  }
\CommentTok{  Critical path:}
\CommentTok{  1. Complete methodology section}
\CommentTok{  2. Verify statistical analysis}
\CommentTok{  3. Create results visualizations}
\CommentTok{{-}{-}\textgreater{}}
\end{Highlighting}
\end{Shaded}
...
\item
  \textbf{One thought ≈ one line-break} -- err on the side of
  whitespace.
\end{enumerate}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, left=2mm, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, breakable, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Chapter Overview}, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, left=2mm, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, breakable, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Key Insight}, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, left=2mm, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, breakable, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Key Developments}, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, left=2mm, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, breakable, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Validation Success}, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, left=2mm, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, breakable, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Validation Protocol}, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, left=2mm, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, breakable, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Integration Architecture}, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, left=2mm, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, breakable, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Performance Highlights}, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, left=2mm, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, breakable, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Early Results}, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, left=2mm, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, breakable, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{The Stakes}, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, opacityback=0, colback=white]
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# @title 4.3 {-}{-}{-} Main Visualization Function {-}{-}{-} [main\_visualization\_function]}
...
\chapter{Quick check HTML Outputs}\label{quick-check-html-outputs}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# @title 5.1 {-}{-}{-} Quick check HTML Outputs{-}{-}{-} [html\_graph\_visualization]}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# @title 5.2 {-}{-}{-} File Import {-}{-}{-} Load Files [file\_import]}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# @title 5.2.2 {-}{-}{-} File Import {-}{-}{-} Load Files [file\_import2]}
