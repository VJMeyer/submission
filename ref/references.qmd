...
AMTAIR_Prototype/data/example_carlsmith/AMTAIR_Prototype_example_carlsmith.ipynb#my_code_cell_test

Caveat: Html comments do not work on Notebook inclusion
```
