...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Optional Title}, leftrule=.75mm, colback=white, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, titlerule=0mm, coltitle=black, colframe=quarto-callout-note-color-frame, opacityback=0, bottomrule=.15mm]

Content here

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Important Note2}, leftrule=.75mm, colback=white, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, titlerule=0mm, coltitle=black, colframe=quarto-callout-note-color-frame, opacityback=0, bottomrule=.15mm]
...
\subsection*{Html Graph by Notebook Cell Inclusion? - (from notebook
local
file)}\label{html-graph-by-notebook-cell-inclusion---from-notebook-local-file}
\addcontentsline{toc}{subsection}{Html Graph by Notebook Cell Inclusion?
- (from notebook local file)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\{\{\textless{} embed /AMTAIR\_Prototype/data/example\_carlsmith/AMTAIR\_Prototype\_example\_carlsmith.ipynb\#file\_import echo=true \textgreater{}\}\}}
\end{Highlighting}
\end{Shaded}
...
\addcontentsline{toc}{section}{More Tests}

\markright{More Tests}

\phantomsection\label{pull_html_graph_from_github}
\begin{Shaded}
\begin{Highlighting}[]
\ImportTok{import}\NormalTok{ pandas }\ImportTok{as}\NormalTok{ pd}
\BuiltInTok{print}\NormalTok{(}\StringTok{"AMTAIR is working!"}\NormalTok{)}
...
Graph Visualization for Carlsmith Model
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{10\% of Grade: \textasciitilde{} 14\% of text \textasciitilde{} 4200
words \textasciitilde{} 10 pages}, leftrule=.75mm, colback=white, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, titlerule=0mm, coltitle=black, colframe=quarto-callout-note-color-frame, opacityback=0, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{20\% of Grade: \textasciitilde{} 29\% of text \textasciitilde{} 8700
words \textasciitilde{} 20 pages}, leftrule=.75mm, colback=white, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, titlerule=0mm, coltitle=black, colframe=quarto-callout-note-color-frame, opacityback=0, bottomrule=.15mm]
