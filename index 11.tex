...
\subsection*{Appendix A: Technical Implementation
Details}\label{sec-appendix-technical}
\addcontentsline{toc}{subsection}{Appendix A: Technical Implementation
Details}

\subsection*{Appendix B: Validation Datasets and
Benchmarks}\label{sec-appendix-validation}
\addcontentsline{toc}{subsection}{Appendix B: Validation Datasets and
Benchmarks}

\subsection*{Appendix C: Extended Case
Studies}\label{sec-appendix-cases}
\addcontentsline{toc}{subsection}{Appendix C: Extended Case Studies}

\subsection*{Appendix D: Ethical Considerations and
Governance}\label{sec-appendix-ethics}
\addcontentsline{toc}{subsection}{Appendix D: Ethical Considerations and
Governance}
