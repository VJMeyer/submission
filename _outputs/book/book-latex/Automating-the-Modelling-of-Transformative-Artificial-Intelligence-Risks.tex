...
\addcontentsline{toc}{section}{Testing Figures}

\markright{Testing Figures}
...
\href{https://github.com/VJMeyer/submission}{\includegraphics[width=0.3\linewidth,height=\textheight,keepaspectratio]{images/cover.png}}

\caption[Short caption 4 list of figures as seen in
LoF]{\label{fig-Unique_identifier_for_crossreferencing}Example
Caption/Title 4}

\end{figure}%

Testing crossreferencing grapics
Figure~\ref{fig-Unique_identifier_for_crossreferencing}.
fig-scap=``Short caption'' /* Short caption for list of figures */
fig-alt=``Detailed alt text that describes the image content, type,
purpose, and meaning'' \textgreater{} \textgreater{} /* Appearance
options \emph{/ fig-align=``left\textbar center\textbar right''
width=``X\%'' /} Width as percentage \emph{/ height=``Ypx'' /} Height in
pixels */ \textgreater{} \textgreater{} /* Source \& linking \emph{/
fig-link=``https://source-url.com'' /} Makes image clickable to source
*/ \textgreater{} \textgreater{} /* Layout options \emph{/
fig-column=``margin\textbar page'' /} Places in margin or spans page
width \emph{/ fig-pos=``H'' /} Position specifier (LaTeX) */
\textgreater{} \textgreater{} /* Panels for subfigures (if combining
multiple) \emph{/ fig-subcap=true /} Enable subcaptions */ \}
