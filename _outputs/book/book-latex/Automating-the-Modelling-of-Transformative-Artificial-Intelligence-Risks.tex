...
\section{Sidebars for comments}\label{sidebars-for-comments}

Create Sidebars by applying the .sidebar attribute to a level 1 heading
(for global sidebars) or level 2 heading (for page level sidebars).
