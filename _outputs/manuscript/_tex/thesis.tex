...
\href{https://vjmeyer.com}{\includegraphics[width=0.2\linewidth,height=\textheight,keepaspectratio]{images/cover.png}}

\caption[Short caption]{\label{fig-testgraphic}Caption/Title}

\end{figure}%

Testing crossreferencing grapics Figure~\ref{fig-testgraphic}.
...
\textsubscript{Source:
\href{https://VJMeyer.github.io/submission/chapters/Introduction.qmd.html\#69a51c74-ead9-4301-a680-a151173a4546}{Introduction}}
...
\section*{MANUAL List of Tables}\label{manual-list-of-tables}
\addcontentsline{toc}{section}{MANUAL List of Tables}
...
\section*{MANUAL List of Graphics \&
Figures}\label{manual-list-of-graphics-figures}
\addcontentsline{toc}{section}{MANUAL List of Graphics \& Figures}

\section*{MANUAL List of
Abbreviations}\label{manual-list-of-abbreviations}
\addcontentsline{toc}{section}{MANUAL List of Abbreviations}
