...
### Html Graph by Notebook Cell Inclusion? - (from notebook local file)

``` markdown
{{< embed /AMTAIR_Prototype/data/example_carlsmith/AMTAIR_Prototype_example_carlsmith.ipynb#html_graph_visualization echo=true >}}
```
...
``` markdown
{{< embed /AMTAIR_Prototype/data/example_carlsmith/AMTAIR_Prototype_example_carlsmith.ipynb#online_model echo=true >}}
```
...
#| echo: true
#| eval: true
#| label: pull_html_graph_from_github
#| fig-cap: "Graph Visualization for Carlsmith Model"
#| fig-link: "https://colab.research.google.com/drive/your-notebook-id"
#| fig-alt: "Detailed description for accessibility"
