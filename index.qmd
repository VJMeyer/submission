...
1. **Before writing**  
   ...
   - Load latest YAML (`project`, `format`, bibliography).
...
3. **After writing**  
   - Run `quarto render --to html` locally; resolve warnings.  
   - Tick off § Rigorous Checklist; commit with message “feat(section): x – refs/glossary/figs updated”.
