...
subtitle: "An Epistemic Framework for Leveraging Frontier AI Systems to Upscale Conditional Policy Assessments in Bayesian Networks on a Narrow Path toward Existential Safety"
author:
...
```
<!-- [ ] GLOBAL: American Spelling Check -->
...
<!-- [ ] VERIFY: Acknowledgments completeness -->

  Add specific names of:
  - MTAIR team members
  - Technical advisors
  - Domain experts who participated in validation
...
<!-- Quarto will auto-generate TOC based on headers -->

# Abstract {#sec-abstract .unnumbered}

<!-- Abstract already complete in frontmatter -->
...
<!-- [ ] EXPAND: Additional abbreviations as needed -->
...
<!-- [ ] REFINE: Research question formulation for maximum clarity and impact -->
...
<!-- [ ] CREATE: {#fig-carlsmith-decomposition}: "Visual flowchart of Carlsmith's six premises with probabilities" -->
...
<!-- [ ] IMPLEMENT: Full Carlsmith model extraction as primary validation case -->
...
<!-- [ ] FIND: @deep-uncertainty-policy: "Knight (1921) or modern treatments of deep uncertainty in policy" -->
...
<!-- [ ] VERIFY: @traditional-policy-methods: "Standard references on policy analysis limitations" -->
...
<!-- [ ] Manual Extraction Time Analysis -->
...
## 2.6 Requirements for Coordination Infrastructure {#sec-coordination-requirements}
...
### 2.6.1 Scalability {#sec-scalability-req}
...
<!-- [ ] CREATE: {#tbl-content-sources}: "Taxonomy of AI safety content sources with volumes" -->

### 2.6.2 Accessibility {#sec-accessibility-req}
...
<!-- [ ] FIND: @stakeholder-requirements: "User research on AI governance tool needs" -->

### 2.6.3 Epistemic Virtues {#sec-epistemic-virtues}
...
<!-- [ ] CREATE: {#fig-epistemic-workflow}: "How AMTAIR preserves epistemic virtues" -->

### 2.6.4 Integration Capabilities {#sec-integration-req}
...
<!-- [ ] IMPLEMENT: API documentation and integration examples -->

### 2.6.5 Robustness Properties {#sec-robustness-req}
...
<!-- [ ] VERIFY: Requirements completeness through stakeholder interviews -->
...
### 3.1.1 Five-Stage Pipeline {#sec-five-stage-pipeline}
...
<!-- [ ] CREATE: {#fig-pipeline-architecture}: "Detailed AMTAIR pipeline with data flow and components" -->

### 3.1.2 Component Architecture {#sec-component-architecture}
...
<!-- [ ] IMPLEMENT: Full component documentation with interfaces -->
...
<!-- [ ] VERIFY: Probability mapping methodology with literature support -->
...
## 3.3 Implementation Details {#sec-implementation-details}
...
<!-- [ ] CREATE: {#tbl-tech-stack}: "Complete technology stack with versions and purposes" -->
...
<!-- [ ] IMPLEMENT: Algorithm pseudocode for key functions -->
...
{{< embed /AMTAIR_Prototype/data/example_carlsmith/AMTAIR_Prototype_example_carlsmith.ipynb#policy-evaluation echo=true >}}
...
<!-- [ ] Prediction Market Integration Architecture -->
...
## 3.10 Computational Considerations {#sec-computational}
...
## 3.11 Summary of Technical Achievements {#sec-technical-summary}
