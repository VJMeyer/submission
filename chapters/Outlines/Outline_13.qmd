...
<!-- [ ] FIND: @todd? url: https://benjamintodd.substack.com/p/looks-like-there-are-some-good-funding
        add as reference for more resources
-->
...
<!-- [ ] FIND: @our_world_data url: https://hai-production.s3.amazonaws.com/files/hai_ai_index_report_2025.pdf
  Add citation for page 85 as evidence for accelerating capabilities
-->

<!-- [ ] FIND: @our_world_data url: https://ourworldindata.org/scaling-up-ai  
    Add as citation for accelerating capabilities
-->
...
<!-- [ ] FIND: @? url: https://futureoflife.org/open-letter/ai-principles/
    and add citation (as footnote) 
-->


<!-- [ ] FIND: @? url: https://artificialintelligenceact.eu/the-act/ 
    and add citation (as footnote)
-->
...
<!-- [ ] FIND @? Url: https://www.prismaguard.com/the-elephaint-are-we-all-like-the-six-blind-men-when-it-comes-to-ai/--> 
...
<!-- [ ] VERIFY: CITE @: from: https://warontherocks.com/2025/01/the-battle-for-brilliant-minds-from-the-nuclear-age-to-ai/ -->
...
<!-- [ ] FIND: @argdown url: https://argdown.org/ 
    add as reference for argdown 
-->
...
<!-- [ ] TODO: Complete policy evaluation for "A Narrow Path" --> 
<!-- [ ] TODO: Complete evaluation for SB 1047 provisions -->
